...
ti.targets.msp430.elf.MSP430X.rootDir ?= C:/ti/ccsv7/tools/compiler/ti-cgt-msp430_16.9.6.LTS
...
.dlls,e430X .dlls: empty_min.pe430X

-include package/cfg/empty_min_pe430X.mak
-include package/cfg/empty_min_pe430X.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/empty_min_pe430X.dep
endif
empty_min.pe430X: package/cfg/empty_min_pe430X.xdl
	@


ifeq (,$(wildcard .libraries,e430X))
empty_min.pe430X package/cfg/empty_min_pe430X.c: .libraries,e430X
endif

package/cfg/empty_min_pe430X.c package/cfg/empty_min_pe430X.h package/cfg/empty_min_pe430X.xdl: override _PROG_NAME := empty_min.xe430X
package/cfg/empty_min_pe430X.c: package/cfg/empty_min_pe430X.cfg
package/cfg/empty_min_pe430X.xdc.inc: package/cfg/empty_min_pe430X.xdl
package/cfg/empty_min_pe430X.xdl package/cfg/empty_min_pe430X.c: .interfaces

clean:: clean,e430X
	-$(RM) package/cfg/empty_min_pe430X.cfg
	-$(RM) package/cfg/empty_min_pe430X.dep
	-$(RM) package/cfg/empty_min_pe430X.c
	-$(RM) package/cfg/empty_min_pe430X.xdc.inc

clean,e430X::
	-$(RM) empty_min.pe430X
.executables,e430X .executables: empty_min.xe430X

empty_min.xe430X: |empty_min.pe430X

-include package/cfg/empty_min.xe430X.mak
empty_min.xe430X: package/cfg/empty_min_pe430X.oe430X 
	$(RM) $@
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/cl430 -q -u _c_int00 -z  -o $@ package/cfg/empty_min_pe430X.oe430X   package/cfg/empty_min_pe430X.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
	
empty_min.xe430X: export C_DIR=
empty_min.xe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
empty_min.xe430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

empty_min.test test,e430X test: empty_min.xe430X.test

empty_min.xe430X.test:: empty_min.xe430X
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 empty_min.xe430X.test
else
	@$(MSG) running $<  ...
	$(call EXEC.empty_min.xe430X, ) 
endif

clean,e430X::
	-$(RM) $(wildcard .tmp,empty_min.xe430X,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
empty_min_pe430X.oe430X,copy : package/cfg/empty_min_pe430X.oe430X
empty_min_pe430X.se430X,copy : package/cfg/empty_min_pe430X.se430X
